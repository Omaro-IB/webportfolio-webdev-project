      ...
      <div className="bg-beige h-full w-screen flex flex-row">
        <NavbarEx />
          ...
          <div className="origin-center mx-auto flex flex-col mt-[15vh] w-[90vw] sm:w-[50vw]">
              ...
              <p style={{fontFamily: 'Verdana', marginTop: '28px'}}>  And here's an <a href="https://stackoverflow.com" className="text-buttongreen hover:text-buttongreenhighlight">inline</a> link. </p>
